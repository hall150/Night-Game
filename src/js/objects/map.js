...
function createTrees() {
  createTree(64, MAP_HEIGHT - 64, 73);
  createTree(320, MAP_HEIGHT - 64, 72);
  createTree(480, MAP_HEIGHT - 64, 72);
  createTree(640, MAP_HEIGHT - 64, 73);
  createTree(736, MAP_HEIGHT - 64, 72);
  createTree(1056, MAP_HEIGHT - 128, 72);
  createTree(1616, MAP_HEIGHT - 64, 73);
  createTree(4224, MAP_HEIGHT - 64, 72);
}

function createTree(x,y,frame) {
  var tree = GAME.add.sprite(x, y, 'background-objects',frame);
}

function buildSlopes() {
  // Slopes
	GAME.mapSlope = GAME.add.tilemap('forrest');
